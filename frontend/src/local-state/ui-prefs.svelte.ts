...
export type LeftPanelTabId = 'picks' | 'events' | 'relations' | 'regions' | 'recordings' | 'settings';
...
class UiPrefs {
  ...
  /** Imperative helper: open settings-tab (voice-over settings). */
  showSettingsTab(): void {
    this.leftPanelTab = 'settings';
  }
